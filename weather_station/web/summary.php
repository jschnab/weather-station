...
echo "<td class='value'>" . avg_day_param("temperature", "living room") . " &deg;C</td>";
echo "</tr>";
echo "<tr>";
echo "<td>Average night temperature</td>";
echo "<td class='value'>" . avg_night_param("temperature", "living room") . " &deg;C</td>";
echo "</tr>";
echo "<tr>";
...
echo "</tr>";
echo "<tr>";
echo "<td>Average day humidity</td>";
echo "<td class='value'>" . avg_day_param("humidity", "living room") . " %</td>";
echo "</tr>";
echo "<tr>";
echo "<td>Average night humidity</td>";
echo "<td class='value'>" . avg_night_param("humidity", "living room") . " %</td>";
echo "</tr>";
echo "</table>";
echo "</section>";
...
echo "<tr>";
echo "<td>Average day temperature</td>";
echo "<td class='value'>" . avg_day_param("temperature", "master bedroom") . " &deg;C</td>";
echo "</tr>";
echo "<tr>";
echo "<td>Average night temperature</td>";
echo "<td class='value'>" . avg_night_param("temperature", "master bedroom") . " &deg;C</td>";
echo "</tr>";
echo "<tr>";
echo "<td>Current humidity</td>";
...
echo "<tr>";
echo "<td>Average day humidity</td>";
echo "<td class='value'>" . avg_day_param("humidity", "master bedroom") . " %</td>";
echo "</tr>";
echo "<tr>";
echo "<td>Average night humidity</td>";
echo "<td class='value'>" . avg_night_param("humidity", "master bedroom") . " %</td>";
echo "</tr>";
echo "</table>";
echo "</section>";
?>
